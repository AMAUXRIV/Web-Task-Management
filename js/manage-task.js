document.addEventListener('DOMContentLoaded',() => {
    ...
    function capitalizerFirstChar(str){
        if(!str ) return str;
    ...
    //membuat objek dari class Task
    const myTasks = new Task();

    //membuat variable untuk  mengambil semua tasks
            ...
            <div class="task-card flex flex-col gap-5">
                            <div class="flex gap-3 items-center">
                                ...
                                <div class="flex flex-col">
                                    <p class="font-bold text-lg leading-[27px]">${capitalizerFirstChar(task.taskName)}</p>
